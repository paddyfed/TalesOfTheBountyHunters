  ...
  return (
    <Layout>
      ...
      <p>
        <b>Plot:</b>
        <br />
        To take over Jabba's Empire, to take over Rayloth
      </p>
      <p>
        <b>Reason:</b>
        <br />
      ...
      <br />
      When Bib Fortuna left his home world of Rayloth he vowed to come back and
      rule the Planet. He took an infant, Nat Secura, with him. Nat was the last
      surviving member of a clan on Rayloth and Bib knew that he would be
      helpful when he decided to return. He made his way to Jabba's palace on
      ...
      <p>
        ...
        many of the Hutt's accounts. When Luke Skywalker and Princess Leia came
        to the palace to free Han Solo, Bib advanced his plans to kill Jabba. He
        had originally planned to feed Jabba to the Rancor but Luke stopped that
        idea.
      </p>
      <p>
        He placed his personal speeder bike on the sail barge and went with
        Jabba to the Pit of Carkoon, taking with him a thermal detonator, which
        he would use to kill the Hutt and then return to take over the palace.
      </p>
      <b>Outcome:</b>
      <br />
      ...
      <b>My Opinion:</b>
      <br />
      Bib's plot, out of all the other plots in the palace, was the most likely
      to have worked. Bib showed great patience with his dealings with the Hutt
      and he could've waited a lot longer before making his move. It is only
      with the introduction of the Rebel Alliance heroes that he became reckless
      and lost some of his nerve.
      <p>When this happened Bib Fortuna's plan was destined to fail.</p>
    </Layout>
  );
}
