  ...
  return (
    <article>
      ...
      <p>
        ...
        the galaxy's most notorious and dangerous gangster. Surrounding himself
        with bounty hunters, assassins, slave girls and smugglers you'd think
        that Jabba would be wary of the plotting that went on under his nose.
      </p>

      <p>
        Instead the Hutt was unconcerned about these many and varied plots (Bib
        Fortuna counted fourteen different plots against Jabba's life and sixty
        five different plots to rob the palace). In fact he was quite arrogant
        in his dealings with them. He would let them continue for a while but
        before the plot could be executed, Jabba would capture the traitors. The
        usual punishment being a trip to the Rancor pit.
      </p>
      <Image
        src={JabbaSailBarge}
        width={300}
      ...
      <p>
        ...
        was surprised and unprepared for how this young man could affect him and
        his criminal empire...
      </p>
      <hr />
      <p>
      ...
      <p>
        In each section you will find information on the conspirator themselves
        and their plot. It will also show the outcome of the plot and, in my
        opinion, whether or not the plot could have worked. Some related links
        to the official site are also supplied.
      </p>
      <Image
        src={JabbaTheHutt}
        width={300}
      ...
      <p>
        ...
        <Link href="/jabbaspalace/mara-jade">Mara Jade</Link>&nbsp;the Emperor's
        Hand,&nbsp;
        <Link href="/jabbaspalace/tessk">Tessk</Link>&nbsp;the Quarren,&nbsp;
        <Link href="/jabbaspalace/ree-yees">Ree-Yees</Link>&nbsp;the Gran,&nbsp;
      ...
      <p>
        ...
        Characters" by Andy Manguels. The pictures of the conspirators also come
        from this book and were drawn by Michael Butkus. Other pictures are
        from&nbsp;
      ...
      <p>
        If you are new to "Star Wars" or you haven't read either of these books
        then I have supplied a small index of characters, creatures and aliens
        that are mentioned throughout this site. If you see something that you
        don't understand, go to the&nbsp;
